...
namespace project.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var appDBContext = _context.Books.Include(b => b.Author).Include(b => b.Publisher).Include(b => b.Store);
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,Description,AuthorId,PublisherId,StoreId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Title,Description,AuthorId,PublisherId,StoreId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
